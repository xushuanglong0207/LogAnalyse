 ...
 */ export function ClientPageRoot(param) {
    ...
    if (typeof window === 'undefined') {
        ...
        if (store.isStaticGeneration) {
            ...
            const { createPrerenderSearchParamsFromClient } = require('../../server/request/search-params');
            clientSearchParams = createPrerenderSearchParamsFromClient(store);
            const { createPrerenderParamsFromClient } = require('../../server/request/params');
            clientParams = createPrerenderParamsFromClient(params, store);
        } else {
            const { createRenderSearchParamsFromClient } = require('../../server/request/search-params');
            clientSearchParams = createRenderSearchParamsFromClient(searchParams, store);
            const { createRenderParamsFromClient } = require('../../server/request/params');
