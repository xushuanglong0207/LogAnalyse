...
export declare function createPrerenderParamsFromClient(underlyingParams: Params, workStore: WorkStore): Promise<Params>;
export declare function createRenderParamsFromClient(underlyingParams: Params, workStore: WorkStore): Promise<Params>;
